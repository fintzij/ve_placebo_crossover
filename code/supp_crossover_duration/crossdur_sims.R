...
crosspd = sim_settings[simnum, "crossdur"]
n_cross = NULL
t_cross = 1 - crosspd / 2 / 52
...
sim_one <- function(n,
                    ...
                    crossdur = crosspd/52,  # crossover period
                    pvacc = 0.5) {
...
saveRDS(trials, file = paste0("cross_sim_", ve, "_", crosspd,".Rds"))
