...
sim_settings <- 
  expand.grid(cross = c("events", "time", "parallel"),
              ve = c("waning", "constant"),
              yr2 = c("same", "half"))

cross = sim_settings[simnum, "cross"]
yr2 = sim_settings[simnum, "yr2"]
...
sim_pars = 
  if(yr2 == "same") {
    c(VE_max = ifelse(ve == "constant", log(1 - 0.75), log(1 - 0.85)),
      ...
      lambda_1 = 0.138, # 100 / 6 months
      lambda_2 = 0.21, # 150 / 6 months
      lambda_3 = 0.138, # 100 / 6 mo
      lambda_4 = 0.068, # 50  / 6 months
      lambda_5 = 0.138, 
      lambda_6 = 0.21,
      lambda_7 = 0.138,
      lambda_8 = 0.068,
...
saveRDS(trials, file = paste0("cross_sim_", ve, "_", cross, "_", yr2,".Rds"))
